jQuery(document).ready((function(e){e(".category-list li").has("ul.children").addClass("has-children"),e(".category-list li.has-children > a").on("click",(function(t){t.preventDefault();var n=e(this).parent(),s=n.find("> ul.children");n.hasClass("expanded")?(n.removeClass("expanded"),s.slideUp()):(n.addClass("expanded"),s.slideDown())}));var t=e(".category-list .current-cat");t.parents("li").addClass("expanded"),t.parents("ul.children").show()})),$(document).ready((function(){function e(){$(".attribute-filters__select select").each((function(){const e=$(this),t=e.parent(),n=t.find(".reset-button"),s=t.find(".vertical-line");""!==e.val().trim()?(t.addClass("option-selected"),n.css("opacity","1"),s.css("display","block")):(t.removeClass("option-selected"),n.css("opacity","0"),s.css("display","none"))}))}e(),$(".attribute-filters__select select").on("change",(function(){e()})),$(".reset-button").on("click",(function(){const e=$(this).parent().find("select");e.val(""),e.trigger("change")})),function(e){let t=window.location.href;new MutationObserver((()=>{const n=window.location.href;n!==t&&(t=n,e())})).observe(document,{subtree:!0,childList:!0})}(e)}));
document.addEventListener("DOMContentLoaded",(function(){var e=Array.from(document.querySelectorAll(".block-slider"));console.log("searchSections",e),e.forEach((e=>{const o=e.querySelector(".swiper");if(console.log("swiper",o),o){const r=o.getAttribute("id");if(console.log("swiperID",r),r){const o=e.querySelector("#next_"+r.replace("slider_swiper",""));console.log("sliderNextBtn",o);const l=e.querySelector("#prev_"+r.replace("slider_swiper",""));console.log("sliderPrevBtn",l);const i=e.querySelector("#pagination_"+r.replace("slider_swiper",""));console.log("sliderPagination",i);new Swiper("#"+r,{direction:"horizontal",slidesPerView:1,slidesPerGroup:1,autoHeight:!0,loop:!0,navigation:{nextEl:o,prevEl:l},pagination:{el:i,clickable:!0}})}}}))}));
